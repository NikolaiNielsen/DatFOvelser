...
hbuttom=uicontrol('Style','pushbutton',...
    ...
    'String', 'Push me for red text',...
    'BackgroundColor','red');

hgreenbutton = uicontrol('Style', 'pushbutton',...
    'position', [0, 100, 100, 25],...
    'Callback',@callbackfkt,...
    'String', 'Push me for green text!',...
